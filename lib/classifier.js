...
Classifier.prototype.test = function( test ) {
  ...
  var n_fac = likedProbs + dislikedProbs;
  likedProbs = likedProbs / n_fac;
  dislikedProbs = dislikedProbs / n_fac;
